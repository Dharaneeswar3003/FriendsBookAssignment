...
public class Controller {
    ...
    //requires: firstNameTextField, lastNameTextField, ageTextField, phoneNumberTextField are not null and contain valid input data.
     //modifies: this.friendsList, this.displayList, this.firstNameTextField, this.lastNameTextField, this.ageTextField, this.phoneNumberTextField
     //effects:  If the input fields contain valid data, creates a new Friends object and adds it to friendsList and displayList.
    @FXML
public void confirmAdd(ActionEvent actionEvent) {
    ...
    //Method to display friends...
     //requires: mouseEvent is not null
     //modifies: this.fNameLabel1, this.lNameLabel1, this.ageLabel1, this.phoneLabel1
     //effects:  Updates the labels to show the details of the selected friend from displayList.
    @FXML
    ...
    //Method when display tab is first opened...
     //requires: mouseEvent is not null
     //modifies: this.fNameLabel, this.lNameLabel, this.ageLabel, this.phoneLabel
     //effects:  Updates the labels to show the details of the selected friend from friendsList.
    @FXML
    ...
    //Method to confirm deletion...
     ...
     //modifies: this.friendsList, this.displayList, this.fNameLabel, this.lNameLabel, this.ageLabel, this.phoneLabel, this.fNameLabel1, this.lNameLabel1, this.ageLabel1, this.phoneLabel1
     //effects:  If a friend is selected and confirmed for deletion, removes the friend from friendsList and displayList.
    @FXML
    ...
    //modifies: System (exits the application if confirmed)
    //effects:  Displays a confirmation dialog. If the user confirms, exits the application.
    @FXML
    ...
    //Method to clear all fields...
     //requires: none
     //modifies: this.firstNameTextField, this.lastNameTextField, this.ageTextField, this.phoneNumberTextField
     //effects:  Clears the text in firstNameTextField, lastNameTextField, ageTextField, and phoneNumberTextField.
